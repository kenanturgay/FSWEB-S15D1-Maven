...
public class Grocery {
    ...
    public void startGrocery() {
        ...
        do {
            ...
            System.out.println("Yapılmak istenen operasyonu seçin. 1- ekleme , 2-Çıkar, 0-çıkış");
    ...
    public static void removeItems(String itemsToRemove) {
        ...
        for(String item: splitItems){
            ...
            if(!checkItemsInList(item)){
                System.out.println("Grilen item liste mevcut değil: "+ item);
            }else {
    ...
    public static void printSorted(){
        sortItems();
        System.out.println("Mevcut pazar lsitesi: ");
